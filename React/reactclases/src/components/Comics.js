...
class Comics extends Component {
  ...
  eliminarComic = (index) =>{
    ...
    //ESTE METODO RECIBE DOS PARMETROS
    //1) INDICE A ELIMINAR
    ...
    return (
      <div>
        ...
        this.state.comics.map((comic, index) => {
          return <Comic key={index} indice={index} comic={comic} seleccionarFavorito={this.seleccionarFavorito} eliminarComic={this.eliminarComic}/>;
        })
        }
      </div>
    );
