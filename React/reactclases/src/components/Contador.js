...
class Contador extends Component {
    //LAS VARIABLES Y LOS METODOS SE DECLARAN
    //FUERA DEL RENDER
    ...
    //EL CONCEPTO DE state ES EXACTAMENTE EL MISMO, VARIABLES QUE NECESITAMOS QUE SEAN DIBUJADAS, ES DECIR, QUE CAMBIEN EL render()
    ...
    render(){
        return(<div>
            ...
            {/* LA LLAMADA A LOS METODOS DE LA CLASE SE REALIZA DE FORMA MAS SENCILLA
            NO SE UTILIZAN PARENTESIS NI NADA, SOLAMENTE EL NOMBRE DEL METODO A EJECUTAR */}
            <button onClick={this.incremetarValor}>Incremetar Valor</button>
            {/* VAMOS A LLAMAR A ESTE METODO MEDIANTE UNA FUNCION ANONIMA */}
            <button onClick={() =>{
                //PARA LA LLAMADA A LOS METOdOS DE LA CLASE DEBEMOS UTILIZAR this
                this.incrementarNumero();
                //PARA LOS METODOS EXTERNOS NO SE UTILIZA LA PALABRA this
                metodoExterno();
