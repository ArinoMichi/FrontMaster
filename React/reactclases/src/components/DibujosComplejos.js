...
class DibujosComplejos extends Component {
    ...
    dibujarNumeros = () =>{
        //DECLARAMOS UN ARRAY PARA GUARDAR TODOS LOS NUMEROS EN FORMATO HTML COMO LISTA
        var lista = [];
        //CON UN BUVLE IREMOS GENERANDO NUMEROS DINAMICOS 
    ...
    render() {
        return(<div>
            <h1 style={{color:"brown"}}>Dibujos Complejos HTML</h1>
            <ul>
                {this.dibujarNumeros()}
            </ul>
        </div>)
