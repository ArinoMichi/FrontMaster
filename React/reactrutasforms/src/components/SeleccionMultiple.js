...
export default class SeleccionMultiple extends Component {
  ...
  mostrarSeleccionados = (e) =>{
    ...
    //PARA PODER ENCONTRAR LOS SELECIONADO, CADA <option>
    //CONTIENE UNA PROPIEDAD LLAMADA selected QUE INDICA SI ESTA
    //SELECCIONADO O NO
    var datos = "";
    //REALIZAMOS UN BUCLE DE REFERENCIA PARA RECORRER CADA ELEMENTO DENTRO DEL ARRAY
    ...
    //MODIFICAMOS EL STATE PARA EL DIBUJO
    this.setState({
        seleccionados : datos
    })
    ...
    return (
      <div>
        ...
        <form onSubmit={this.mostrarSeleccionados}>
            ...
            <button onClick={this.mostrarSeleccionados}>Mostrar Opciones</button>
        </form>
